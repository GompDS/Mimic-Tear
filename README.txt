...
This is a sub-species creation tool for Dark Souls 3.

--| How to use

Enter the required information into config.ini, select conversion settings and finally run MimicTear.exe.
